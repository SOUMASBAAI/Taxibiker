...
export default function ClientCreditHistoryModal({ client, isOpen, onClose }) {
  ...
  const fetchClientCreditHistory = async () => {
    try {
      setIsLoading(true);
      setError(null);
      ...
      if (data.success) {
        // Utiliser directement monthly_summary de l'API
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold">
                  Historique du Crédit Client
                </h2>
                <p className="text-gray-300 text-sm">
                  {userInfo
                    ? userInfo.name
                    : `${client.firstname} ${client.lastname}`}{" "}
                  - {userInfo ? userInfo.email : client.email}
                </p>
              </div>
            </div>
            <button
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  Ce client n'utilise pas le système de crédit mensuel
                </p>
              </div>
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">
                  Ce client n'a pas encore de courses avec crédit mensuel
                </p>
              </div>
            ) : (
